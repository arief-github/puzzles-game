// fungsi untuk menukar posisi kotak berdasarkan parammeter posisi
...
const CORRECT_PUZZLE = ["1", "2", "3", "4", "5", "6", "7", "8", null];
  ...
  switch (action.type) {
    case "move": {
      ...
      return {
        ...state,
        items: newItems,
        complete: arraysEqual(newItems, CORRECT_PUZZLE)
      };
    }
    case "shuffle": {
      let newState = { ...state };
